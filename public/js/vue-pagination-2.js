    ...
    function (t, e, i) {
        ...
        e.default = function () {
            return {
                ...
                template: null,
                texts: {
                    count: (site_lang ==='en') ? "Showing {from} to {to} of {count} records | {count} records | One record" : ((site_lang ==='ar') ? 'نمایش {from} - {to} من {count} السجلات |{count} السجلات | سجل واحد' : ((site_lang.substr(0,2)==='fa') ? " نمایش {from} - {to} از {count} مورد |{count} مورد | یک مورد " : "Showing {from} to {to} of {count} records | {count} records | One record")),
                    first: "First",
                    last: "Last",
                    nextPage: ">",
                    nextChunk: ">>",
