<template>
    <div class="container attachment-zone">
        <vue-dropzone
            ref="myVueDropzone"
            ...
            <div class="dropzone-container p-2 mx-2">
                <div class="file-selector">
                    ...
                    <span class="fs--1">فایل ها را در اینجا بکشید</span>
                    <p class="separator fs--1"><span> یا </span></p>
                    <button class="btn fs--1 btn-primary mb-2" type="button">انتخاب کنید</button>
                </div>
            </div>
        </vue-dropzone>
        <AttachmentList
