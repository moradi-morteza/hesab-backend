...
<template>
    <div class="vue-image-crop-upload" v-show="value" :style="{'direction':direction}">
        <div class="vicp-wrap">
            <div class="vicp-close" @click="off">
                <i class="vicp-icon4"></i>
            </div>
            <div class="vicp-error mb-3" v-show="hasError">
            ...
            <div class="vicp-step1" v-show="step == 1">
                ...
                <div>
                    <ul  style="margin-top: 10px;">
                        <li class="fs--2 mt-1" >{{trans('app.can_not_select_image')}}</li>
                        <li class="fs--2 mt-1"> {{trans('app.should_be_jpg_format')}}</li>
                        <li class="fs--2 mt-1">{{trans('app.des_limit_size_profile_image')}}</li>
                        <li class="fs--2 mt-1">{{trans('app.des_limit_dimensions_profile_image')}}</li>
                    </ul>
                </div>
            ...
            <div class="vicp-step2" v-if="step == 2">
                <div class="vicp-crop">
                    <div class="vicp-crop-left" v-show="true">
                        ...
                        <div class="vicp-range" style="direction: ltr!important;">
                ...
                <div class="vicp-operate">
                    ...
                    <a class="vicp-operate-btn" @click="prepareUpload2" @mousedown="ripple">{{ lang.btn.save }}</a>
                </div>
            </div>
...
export default {
    ...
    methods: {
        ...
        prepareUpload2(){
            ...
            this.setStep(3);
            this.loading = 2;
            this.$emit('crop-upload-success', null, field, ki);
            this.$emit('crop-success', createImgUrl, field, ki);
            this.off();
        },
        // 上传图片
